...
label_column = 'label'
test_inputs, test_labels = load_dataset('../data_collection/test/Pz_AF3_AF4_combined_test_flow_data.csv', input_columns, label_column)
...
model.load_state_dict(torch.load('flow_best_model_checkpoint.pth'))
